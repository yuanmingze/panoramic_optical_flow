...
\TODO{clearly explain the strengths of the methodologies presented in this paper; Our approach supports high-resolution optical flow estimation (e.g. 2K×1K), compared to the limited resolutions supported by CNN-based methods due to model size constraints (e.g. 1024×512 [2]).}


%%\textbf{Limitation \& Future Work}
\paragraph{Limitations.}
\TODO{Large translations.}
\TODO{My current optical flow stitch code can not support large motion, because the Gnomonic Projection. If the pixel move to the back of the OpenGL camera, the gnomonic projection based optical flow code will generate wrong optical flow.}
