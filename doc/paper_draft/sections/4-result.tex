...
We compare our method with \new{the state-of-the-art 360° optical flow method OmniFlowNet \cite{ArtizZAD2020}, as well as the} following state-of-the-art \new{perspective} methods: RAFT~\cite{TeedD2020a}, PWC-Net~\cite{SunYLK2018} and DIS~\cite{KroegTDV2016}.
%
\new{For \href{https://github.com/COATZ/OmniFlowNet}{OmniFlowNet}, we downscale the input images to a resolution of \TODO{W$\times$H\,pixels} to fit them into 6 GB GPU memory (NVIDIA RTX 2060), and upsample the estimated flow fields to the original image resolution.}
%
