...
%% real word dataset
Although the synthetic data is very close to real-world data include shape, texture and light, but the real-world data is more challenging, has complex lighting and motion, etc. 
%
...
We compare our method with following state of the art methods, RAFT~\cite{TeedD2020a}, PWC-Net~\cite{SunYLK2018} and Dense Inverse Search (DIS)~\cite{KroegTDV2016}. 
%
We use the offical implemented RAFT and PWC-Net \href{https://github.com/NVlabs/PWC-Net}{NVlabs/PWC-Net}, and OpenCV implemneted DIS. 
...
\begin{table}[h!]
	...
	\begin{tabular}{p{0.2cm}p{1.6cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}}
		...
		\multirow{3}{*}{\rotatebox[origin=c]{90}{Circle}} & PWCNet & 16.60 & 0.2994  & 63.44  & 0.0588 & 0.1469 & 0.3845 \\ 
		 ...
		 & Our & \textbf{4.854} & \textbf{0.1863}  & 37.10 & 0.007118 & 0.05074 & 0.01899 \\ 
		 & Our(W) & 4.988 & 0.1885 & 39.26 & 0.007241 & 0.05278 & 0.01824 \\ 
		\hline
		...
		& Our(W) & 10.41 & 0.2462  & 55.78 & 0.01533 & 0.08943 & 0.03448 \\ 
		\hline
		...
		& Our(W/OB)  & \textbf{7.524}  & 0.2129  &  42.94 & 0.01161 & 0.06967 & 0.02741 \\
		& Our & 8.602 & 0.2270  & 50.27 & 0.01264 & 0.07722 & 0.02907 \\
		& Our(W/O cube) & 7.921 & 0.2182  & 47.91 & 0.01146 & 0.07114 & 0.02492 \\
		& Our(W/O Ico) & 5.023 & 0.2140  & 31.97 & 0.009781 & 0.06662 & 0.02308 \\
		\hline
	\end{tabular}
\end{table}
...
%		\labeledfig{images/of_error/room_0_circ_1k_0_raft_0002_opticalflow_backward_pano.flo_error_vis.jpg}{0.185}{(j) $RAFT\_SEPE$}{black}
	...
	\caption{\label{fig:exp:compflow}
		The optical flow results on Replica, 1st and 2nd rows are the result on the Replica $office\_0$ result, which are optical flow and optical flow $SEPE$ error heatmap respectively, darker is more error. And 3rd and 4th rows are part of the result on the Replica $apartment\_0$.}
\end{figure*}
