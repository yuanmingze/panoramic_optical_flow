...
The 360° Replica dataset rendering with two kinds of camera path circle and line. The circle path (\emph{Circle}) is the camera face to outward and moves along a circle (\TODO{how much radian and image per circle}), the line path (\emph{Line}) is the camera face the same direction and moves in a straight line.
