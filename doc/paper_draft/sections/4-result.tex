...
\new{The `Ful Method' outperforms the `w/o weight' because the blending weight brings down the unreliable optical flow, such as the pixels move out or in one tangent image boundary but they can get reliable results on other tangent images' corresponding pixels.}
