...
% blending method
\TODO{Visualized different weight and blend result, and show each face's optical flow.}
\begin{equation}
W_{face} =
\end{equation}
...
Inspired by the warping base optical flow~\cite{?} we use the global rotation to align the $I_{t+1}$ to $I_{t}$ for compensation the tangent image small FoV and reduce the large pixel motion span.
