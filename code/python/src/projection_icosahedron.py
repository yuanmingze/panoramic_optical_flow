...
def ico2erp_image(tangent_images, erp_image_height, padding_size=0.0, blender_method=None):
    ...
    for triangle_index in range(0, 20):
        ...
        erp_image_col_start, erp_image_row_start = sc.sph2erp(availied_ERP_area[0], availied_ERP_area[2], erp_image_height, erp_modulo=False)
        erp_image_col_stop, erp_image_row_stop = sc.sph2erp(availied_ERP_area[1], availied_ERP_area[3], erp_image_height, erp_modulo=False)
        ...
        if blender_method is None:
            ...
            # import image_io
            # image_io.image_show(erp_weight_mat)
...
def ico2erp_flow(tangent_flows_list, erp_flow_height=None, padding_size=0.0, image_erp_src=None, image_erp_tar=None, wrap_around=False, face_blending_method="straightforward"):
    ...
    for face_index in range(0, len(tangent_flows_list)):
        ...
        # import flow_vis
        # flow_vis.flow_value_to_color(erp_flow_mat, visual_colormap="hsv")
    # compute the final optical flow base on weight
