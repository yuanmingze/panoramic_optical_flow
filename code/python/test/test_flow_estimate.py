...
def test_multi_step_flow_0(erp_src_image_filepath, erp_tar_image_filepath, erp_opticalflow_output_filepath):
    ...
    optical_flow = flow_estimate.pano_of_0(src_erp_image, tar_erp_image)
