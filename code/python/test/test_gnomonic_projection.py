...
def test_reverse_gnomonic_projection():
    ...
    """
    # # the ERP image seam
    # tangent_point_phi = np.pi
    # tangent_point_theta = 0

    # # the north pole
    # tangent_point_phi = 0
    # tangent_point_theta = np.pi / 2.0
    ...
    sph_list_x, sph_list_y = gp.reverse_gnomonic_projection(tangent_x, tangent_y, tangent_point_phi, tangent_point_theta)
...
def test_gnomonic_projection():
    ...
    # tangent_point_phi = 0.0
    # tangent_point_theta = 0.0
    tangent_point_phi = 0.5
    tangent_point_theta = -0.1
    ...
    sph_list_x, sph_list_y = gp.gnomonic_projection(tangent_x, tangent_y, tangent_point_phi, tangent_point_theta)
