...
def test_opticalflow_metric(erp_flo_gt_filepath, erp_flo_eva_filepath, erp_flo_mask_filepath, erp_flo_output_dir):
    ...
    aae_mat_vis = image_io.visual_data(aae_mat)
    ...
    aae_mat_sph_vis = image_io.visual_data(aae_mat_sph)
    ...
    epe_mat_vis = image_io.visual_data(epe_mat)
    ...
    epe_mat_sph_vis = image_io.visual_data(epe_mat_sph)
    ...
    rms_mat_vis = image_io.visual_data(rms_mat)
    ...
    rms_mat_sph_vis = image_io.visual_data(rms_mat_sph)
